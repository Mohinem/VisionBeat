...
- detect candidate punch or strike gestures,
...
5. start a candidate when onset conditions are met,
6. expire the candidate if the motion weakens or confirmation takes too long,
